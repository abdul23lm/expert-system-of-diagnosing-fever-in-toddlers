						...
						<div class='box-content'>
							<div class='feed-list'>
									<div class='row'>
										<div class='col-md-12'>";?>
											...
											$(document).ready(function() {
												dTable = $('#example').DataTable( {
													...
													"bJQueryUI": false,
													"responsive": true,
													"sAjaxSource": "partials/aturan_tidak.php", // Load Data
													"sServerMethod": "POST",
													"columnDefs": [
										...
										<button onClick="showModals()" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Aturan Tidak</button>
										<br>
										<hr>
										<br>
											...
											<div class="modal-dialog">
												<div class="modal-content">
													<div class="modal-header">
														...
														<h4 class="modal-title" id="myModalLabel"> Tambah Aturan Tidak</h4>
													</div>
													<div class="modal-body">
														...
														<br>
														<form class="form-horizontal" id="formAturanTidak">
															
															<input type="hidden" class="form-control" id="id_aturan_tidak" name="id_aturan_tidak">
													...
													<div class="modal-footer">
														<button type="button" onClick="simpanAturanTidak()" class="btn btn-default btn-sm" id="btn-act" data-dismiss="modal" style="margin-bottom:10px;">Simpan</button>
										...
										<script>		
											...
											function showModals( id )
											{
												...
												{
													$("#myModals").modal("show");
													$("#myModalLabel").html("Tambah Aturan Tidak");
													$("#type").val("new"); 
													$("#btn-act").html("Simpan");
													show_combo_satu();
													show_combo_dua();
											...
											{
												$("#myModalLabel").html("Ubah Aturan tidak");
												$("#id_aturan_tidak").val(data.id_aturan_tidak);
												$("#type").val("edit");
												$("#myModals").modal("show");
											}
											
											//Submit Untuk Eksekusi Tambah/Edit/Hapus Data 
											function simpanAturanTidak()
											{
												var formData = $("#formAturanTidak").serialize();
												waitingDialog.show();
												$.ajax({
													type: "POST",
													url: "./aksi_aturan_tidak.php",
											...
											function deleteAturanTidak( id )
											{
												...
												$.ajax({
													...
													success: function(data) {
														$("#removeWarning").show();
														$("#myModalLabel").html("Hapus Aturan Tidak");
														$("#btn-act").html("Hapus");
														$("#id_aturan_tidak").val(data.id_aturan_tidak);
														$("#type").val("delete");
											...
											{
												$("#removeWarning").hide();
												$("#id_aturan_tidak").val("").removeAttr( "disabled" );
